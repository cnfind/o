...
o:value("192.168.2.1", translate("LocalHost Public DNS (192.168.2.1)"))
...
o:value("183.221.253.100", translate("China Mobile Public DNS (183.221.253.100)"))
o:value("211.137.96.205", translate("China Mobile Public DNS (211.137.96.205)"))
...
o:value("127.0.0.1:7878", translate("LocalProxy Public DNS (127.0.0.1:7878)"))
